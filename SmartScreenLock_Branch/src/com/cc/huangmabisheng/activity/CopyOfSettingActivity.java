...
//	CheckBox handCheckBox;
	...
	protected void handleMsg(Message msg) {
		...
		case Constant.WIFI_CONNECTED:
			WifiAdmin wifiAdmin = WifiAdmin.getInstance(CopyOfSettingActivity.this);
			String ip = wifiAdmin.getIPAddressStr();
			if (!ip.equals("0.0.0.0"))
				specialServiceTitleTextView.setText("已连接："
						+ WifiAdmin.getInstance(CopyOfSettingActivity.this)
								.getWifiInfo().getSSID());
			else {
	...
	protected void setAllListeners() {
		...
		if (isServiceRunning(serviceList,
				"com.cc.huangmabisheng.service.SpecialHttpService")) {
		...
		filterApplicationLayout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(CopyOfSettingActivity.this,
						FilterApplicationActivity.class);
				startActivity(intent);
			}
		});
		SharedPrefrencesAssist.instance(CopyOfSettingActivity.this).write("hand",
				"true");
...
//		});
		...
		photoLayout.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(CopyOfSettingActivity.this,
		...
		ipSettingImageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final SharedPrefrencesAssist spa = SharedPrefrencesAssist
						.instance(CopyOfSettingActivity.this);
				new CloudDialog(CopyOfSettingActivity.this, "请设置ip", spa.read("ip"),
		...
		.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
					boolean isChecked) {
				SharedPrefrencesAssist.instance(CopyOfSettingActivity.this).writeBoolean(Constant.SCREEN_PHOTO_IMAGEVIEW, isChecked);
//				if (isChecked) {
...
//		handCheckBox = (CheckBox) findViewById(R.id.hand_checkbox);
	...
	private void stopAllServices() {
		Intent intent = new Intent(CopyOfSettingActivity.this,
				FloatWindowService.class);
		CopyOfSettingActivity.this.stopService(intent);
		Intent intent1 = new Intent(CopyOfSettingActivity.this,
				SmartLockService.class);
		CopyOfSettingActivity.this.stopService(intent1);
	...
	private void startAllServices() {
		Intent intent = new Intent(CopyOfSettingActivity.this,
				FloatWindowService.class);
		CopyOfSettingActivity.this.startService(intent);
		Intent intent1 = new Intent(CopyOfSettingActivity.this,
				SmartLockService.class);
		CopyOfSettingActivity.this.startService(intent1);
		Application.app.setServiceOnStatus();
	}

	private void startSpecialService() {
		Intent httpIntent = new Intent(CopyOfSettingActivity.this,
				SpecialHttpService.class);
		CopyOfSettingActivity.this.startService(httpIntent);
		specialModuleLayout.setVisibility(View.VISIBLE);
		ipSettingImageView.setVisibility(View.VISIBLE);
	}
	...
	private void stopSpecialService() {
		Intent httpIntent = new Intent(CopyOfSettingActivity.this,
				SpecialHttpService.class);
		CopyOfSettingActivity.this.stopService(httpIntent);
