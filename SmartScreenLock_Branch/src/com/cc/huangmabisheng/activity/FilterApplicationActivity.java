...
import com.cc.huangmabisheng.model.AppInfoForFilter;
...
public class FilterApplicationActivity extends BaseActivity {
	...
	private void appInfoProvider() {
		...
		for (int i = 0; i < packages.size(); i++) {
			...
			if ((packageInfo.applicationInfo.flags & ApplicationInfo.FLAG_SYSTEM) == 0 && !tmpInfo.packageName.equals("com.cc.huangmabisheng")) {
