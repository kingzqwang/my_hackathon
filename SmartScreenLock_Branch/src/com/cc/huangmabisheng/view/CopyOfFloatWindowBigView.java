...
//
//public class CopyOfFloatWindowBigView extends LinearLayout implements
...
//				} else {// 关屏
//					long duration = (long) (800f * (float)gl / (float)viewWidth);
//					duration = duration < 50 ? 50 : duration;
...
////				Log.e(TAG, "开屏结束");
//				CopyOfFloatWindowBigView.this.setVisibility(View.GONE);
//				// service.sendBroadcast(new Intent(
//				// "com.cc.huangmabisheng.finish"));
//
...
//		final int w = com.cc.huangmabisheng.utils.DensityUtil.dip2px(
//				service, 56f);
...
//	}
//
//	public CopyOfFloatWindowBigView(final Context context) {
//		super(context);
//		Log.d(TAG, "oncreate");
...
//			}
//		}else {
//			synchronized (CopyOfFloatWindowBigView.class) {
//				if (visibility != View.GONE)
//					CopyOfFloatWindowBigView.class.notify();
//			}
//		}
//	}
//
